                ...
                <div class="block left-module">
                    ...
                    <div class="block_content">
                        <ul class="testimonials owl-carousel" data-loop="true" data-nav = "false" data-margin = "30" data-autoplayTimeout="1000" data-autoplay="true" data-autoplayHoverPause = "true" data-items="1">
                            <li>
                                <div class="client-mane">Amzad</div>
                                <div class="client-avarta">
                                    <img src="{{URL::to('public/frontend_assets/data/te/amj.JPG')}}" alt="client-avarta">
                                </div>
                            ...
                            <li>
                                <div class="client-mane">Ataullah </div>
                                <div class="client-avarta">
                                    <img src="{{URL::to('public/frontend_assets/data/te/a.JPG')}}" alt="client-avarta">
                                </div>
                                <div class="testimonial">
                                    "Your product needs to improve more. To suit the needs and update your image up"
                                </div>
                            ...
                            <li>
                                <div class="client-mane">Ab.Kayum</div>
                                <div class="client-avarta">
                                    <img src="{{URL::to('public/frontend_assets/data/te/k.JPG')}}" alt="client-avarta">
                                </div>
                                <div class="testimonial">
                                    "Your product needs to improve more. To suit the needs and update your image up"
                                </div>
                            ...
                            <li>
                                <div class="client-mane">Feruz</div>
                                <div class="client-avarta">
                                    <img src="{{URL::to('public/frontend_assets/data/te/f.JPG')}}" alt="client-avarta">
                                </div>
                                <div class="testimonial">
                                    "Your product needs to improve more. To suit the needs and update your image up"
                                </div>
