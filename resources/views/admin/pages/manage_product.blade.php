            ...
            <div class="widget-body">
                <div>
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        ...
                        <tbody>
                            <?php $i = 0 ?>
                            @foreach($product as $all_v)
                            <tr class="">
                                <td>{{++$i}}</td>
                                <td>{{$all_v->product_name}}</td>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-success" href="{{URL::to('published-product/'.$all_v->id)}}">
                                        <i class="halflings-icon white  icon-thumbs-up"></i>  
                                    </a>
                                    @else
                                    <a class="btn btn-danger" href="{{URL::to('unpublished-product/'.$all_v->id)}}">
                                        <i class="halflings-icon white icon-thumbs-down"></i>  
                                    </a>
                                    @endif
                                    <a class="btn btn-info" href="{{ URL::to('edit-product/'.$all_v->id) }}">
